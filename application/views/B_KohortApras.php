...
<body>
    ...
    <div class="page-container">
        ...
        <div class="page-content">
            ...
            <div class="page-title">                    
                <h2><span class="fa fa-arrow-circle-o-left"></span>&nbsp Register Kohort Apras</h2>
            </div>
            <!-- END PAGE TITLE --> 
                            ...
                            <div class="panel-heading">
                                <div class="btn-group pull-left">
                                    <button class="btn btn-info dropdown-toggle" data-toggle="modal" data-target="#modal_tambahRegister">
                                        <i class="fa fa-plus"></i> Tambah Register Apras
                                    </button>
                                </div>
                                    ...
                                    <tbody>
                                        <?php foreach ($data as $row): ?>
                                            <tr style="font-size:10pt;">
                                                <td><?php echo $row->idApras; ?></td>
                                                <td><?php echo $row->namaApras; ?></td>       
                                                ...
                                                <td width="15%">
                                                    <a data-toggle="tooltip" title="Detail Register" >
                                                        <button data-toggle="modal" data-target="#modal_detailRegister<?php echo $row->idApras;?>">
                                                            <span class="glyphicon glyphicon-zoom-in"></span>
                                                        </button>                  
                                                    </a>
                                                    <a  data-toggle="tooltip" title="Ubah Register">
                                                        <button data-toggle="modal" data-target="#modal_ubahRegister<?php echo $row->idApras;?>" >
                                                ...
                                                <td width="30%">
                                                    <a data-toggle="tooltip" title="">
                                                        <button data-toggle="modal" data-target="#modal_tambahPelayanan<?php echo $row->idApras;?>"class="btn btn-sm btn-info">
                                                            <i class="fa fa-plus"></i>Tambah Pelayanan
                                                        </button>
                                                    </a>&nbsp
                                                    <a data-toggle="tooltip" title="">
                                                        <button data-toggle="modal" data-target="#modal_lihatPelayanan<?php echo $row->idApras;?>" class="btn btn-sm btn-success">
    ...
    <div class="message-box message-box-danger animated fadeIn" data-sound="alert" id="mb-hapusRegister">
        <div class="mb-container">
            <div class="mb-middle">
                ...
                <div class="mb-footer">
                    <div class="pull-right">
                        <a href="<?php echo site_url("C_Bidan/hapusRegister")."/".$this->session->userdata('desa')."/apras/".$row->idApras; ?>" class="btn btn-success btn-lg">Ya</a>
                        <button class="btn btn-default btn-lg mb-control-close">Tidak</button>
                    </div>
                </div>
            </div>
    ...
    <div class="message-box message-box-danger animated fadeIn" data-sound="alert" id="mb-hapusPelayanan">
        <div class="mb-container">
            <div class="mb-middle">
                ...
                <div class="mb-footer">
                    <div class="pull-right">
                        <a href="<?php echo site_url("C_Bidan/hapusPelayanan")."/".$this->session->userdata('desa')."/apras/".$row->idApras; ?>" class="btn btn-success btn-lg">Ya</a>
                        <button class="btn btn-default btn-lg mb-control-close">Tidak</button>
                    </div>
                </div>
            </div>
    ...
    <!-- Lihat Pelayanan-->
    <?php foreach ($data as $row) {?>
    <div class="modal" id="modal_lihatPelayanan<?php echo $row->idApras;?>" tabindex="-1" role="dialog" aria-labelledby="defModalHead" aria-hidden="true" style="">
        <div class="modal-dialog modal-lg" style="padding-top:100px;">
            <div class="modal-content">
                <div class="modal-header">
                  <button type="button" class="close" data-dismiss="modal">&times;</button>
                  <h4 class="modal-title">Pelayanan Kohort Apras <?php echo $row->namaApras;?></h4>
              </div>                    
            ...
            <div class="modal-footer ">
                <a  class="mb-control" data-box="#mb-hapusPelayanan"data-toggle="tooltip">
                    <button class="btn btn-danger pull-left" data-toggle="modal" data-target="#modal_hapusPelayanan<?php echo $row->idApras;?>">
                        <span class="glyphicon glyphicon-trash"></span> Hapus Pelayanan
                    </button>
                </a>
                <button data-toggle="modal" data-target="#modal_ubahPelayanan<?php echo $row->idApras;?>" class="btn btn-primary pull-right">
...
<!-- Tambah pelayanan-->
<?php foreach ($data as $row) {?>
<div class="modal" id="modal_tambahPelayanan<?php echo $row->idApras;?>" tabindex="-1" role="dialog" aria-labelledby="defModalHead" aria-hidden="true" style="">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal">&times;</button>
              <h4 class="modal-title">Tambah Pelayanan Apras <?php echo $row->namaApras;?></h4>
          </div>                    
          <div class="modal-body">
            <!-- PAGE CONTENT WRAPPER -->
            <div class="page-content-wrap">
                <div class="row">
                    <div class="col-md-12 block" >        
                        <form class="form-horizontal" method="POST" action="<?php echo site_url("C_Bidan/tambahPelayanan")."/".$this->session->userdata('desa')."/apras/".$row->idApras; ?>" role="form">
                            <div class="panel panel-default">
                                <div class="panel-body">                                                                                   
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="row">                   
                                                        <label class="check"><input value="DDTK ditemukan penyimpangan" type="radio" class="iradio" name="ddtk"/> DDTK ditemukan penyimpangan</label>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="input-group">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="row">                                    
                                                        <label class="check"><input value="Kunjungan rumah" type="radio" class="iradio" name="tempat"/> Kunjungan rumah</label>
                                                    </div>
                                                    <div class="row">                                    
...
<!-- Edit Pelayanan-->
<?php foreach ($data as $row) {?>
<div class="modal" id="modal_ubahPelayanan<?php echo $row->idApras;?>" tabindex="-1" role="dialog" aria-labelledby="defModalHead" aria-hidden="true" style="">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal">&times;</button>
              <h4 class="modal-title">Edit Pelayanan Register Kohort Apras <?php echo $row->namaApras;?></h4>
          </div>                    
          <div class="modal-body">
            <!-- PAGE CONTENT WRAPPER -->
            <div class="page-content-wrap">
                <div class="row">
                    <div class="col-md-12 block" >        
                        <form class="form-horizontal" method="POST" action="<?php echo site_url("C_Bidan/ubahPelayanan")."/".$this->session->userdata('desa')."/apras/".$row->idApras; ?>" role="form">
                            <div class="panel panel-default">
                                <div class="panel-body">                                                                                   
                                    <div class="row">
                                        <div class="col-md-6">
...
<div class="modal" id="modal_tambahRegister" tabindex="-1" role="dialog" aria-labelledby="defModalHead" aria-hidden="true" style="">
    <div class="modal-dialog ">
        <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal">&times;</button>
              <h4 class="modal-title">Tambah Data Register Kohort Apras</h4>
          </div>                    
          <div class="modal-body">
            <!-- PAGE CONTENT WRAPPER -->
            <div class="page-content-wrap">
                <div class="row">
                    <div class="col-md-12">        
                        <form class="form-horizontal" method="POST" action="<?php echo site_url("C_Bidan/tambahRegister")."/".$this->session->userdata('desa')."/apras"; ?>">
                            <div class="panel panel-default">
                                <div class="panel-body">                                                                                   
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">Nama Apras *</label>
                                                <div class="col-md-9">                                            
                                                    <div class="input-group">
                                                    <input name="namaApras" required size="200"  type="text" class="form-control"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">Umur (tahun) *</label>
                                                <div class="col-md-9">                                            
                                                    <div class="input-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">                                            
                                                    <div class="input-group">
                                                        <input name="anakKe" required size="200"  type="number" class="form-control"/>
                                                    </div>
                                                </div>
                                            </div>
											<div class="form-group">
                                                ...
                                                <div class="col-md-9">                                            
                                                    <div class="input-group">
                                                        <input name="beratBadan" required size="200"  type="number" class="form-control"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
...
<!-- Detail Register-->
<?php foreach ($data as $row) {?>
<div class="modal" id="modal_detailRegister<?php echo $row->idApras;?>" tabindex="-1" role="dialog" aria-labelledby="defModalHead" aria-hidden="true" style="">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal">&times;</button>
              <h4 class="modal-title">Detail Data Register Kohort Apras <?php echo $row->namaApras;?></h4>
          </div>                    
          <div class="modal-body">
            <!-- PAGE CONTENT WRAPPER -->
            <div class="page-content-wrap">
                                ...
                                <div class="panel-body">                   
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-5 control-label">Nama Apras</label>
                                                <div class="col-md-7">                                            
                                                    <div class="input-group">
                                                        <input name="namaApras" value="<?php echo $row->namaApras ?>" size="200"  type="text" class="form-control"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-7">                                            
                                                    <div class="input-group">
                                                        <input name="keterangan" value="<?php echo $row->keteranganApras ?>" size="200"  type="text" class="form-control"/>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<!-- Edit Register-->
<?php foreach ($data as $row) {?>
<div class="modal" id="modal_ubahRegister<?php echo $row->idApras;?>" tabindex="-1" role="dialog" aria-labelledby="defModalHead" aria-hidden="true" style="">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal">&times;</button>
          ...
          <div class="modal-body">
            ...
            <div class="page-content-wrap">
                <div class="row">
                    <div class="col-md-12">        
                        <form class="form-horizontal" method="POST" action="<?php echo site_url("C_Bidan/ubahRegister")."/".$this->session->userdata('desa')."/apras/".$row->idApras; ?>" role="form">
                            <div class="panel panel-default">
                                <div class="panel-body">                                                                                   
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-7">                                            
                                                    <div class="input-group">
                                                        <input disabled="disabled" name="idIbu" value="<?php echo $row->idIbu ?>" size="200"  type="number" class="form-control"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
