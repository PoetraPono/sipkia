...
<head>        
    ...
    <!-- CSS INCLUDE -->  
    <?php 
    if ($this->session->userdata('desa')=="puskesmas") {
        include("assets/temaPuskesmas.php") ;
    } else {
      include("assets/temaBidanDesa.php");
  }
  ?>
  <!-- EOF CSS INCLUDE -->
...
<body>
    ...
    <div class="page-container">
        ...
        if ($this->session->userdata('desa')=="puskesmas") {
          ...
          include("assets/menuBidanDesa.php");
      }
      ?>
      <!-- END PAGE SIDEBAR -->
      ...
      <div class="page-content">
        ...
        <div class="page-title">                    
            <h2><span class="fa fa-arrow-circle-o-left"></span>&nbsp Pemetaan PWS-KIA Desa <?php echo ucfirst($desa); ?> Tahun <?php echo $tahun; ?></h2>
        </div>
        <!-- END PAGE TITLE --> 
                                            ...
                                            <div class="tab-pane active" id="tab1">
                                                        ...
                                                        <div class="panel panel-default">
                                                            <div class="panel-heading">
                                                                <div class="btn-group pull-left">
                                                                    <button class="btn btn-info" data-toggle="dropdown"><i class="glyphicon glyphicon-time"></i>Tahun <?php echo $tahun; ?></button>
                                                                    <ul class="dropdown-menu">
                                                                        <li><a href="<?php echo base_url()."C_Bidan/lihatPemetaan/".$desa."/2014"?>"> 2014</a></li>
                                                                        <li><a href="<?php echo base_url()."C_Bidan/lihatPemetaan/".$desa."/2015"?>"> 2015</a></li>
                                                                        <li><a href="<?php echo base_url()."C_Bidan/lihatPemetaan/".$desa."/2016"?>"> 2016</a></li>
                                                                        <li><a href="<?php echo base_url()."C_Bidan/lihatPemetaan/".$desa."/2017"?>"> 2017</a></li>
                                                                    </ul>
                                                                </div>
                                                                <div class="pull-left" style="padding-left:20px;">
                                                                    <a href="<?php echo base_url()."C_Bidan/perbaruiPemetaan/".$desa."/".$tahun?>"><button class="btn btn-warning"><i class="fa fa-refresh"></i>Perbarui Data</button></a>
                                                                </div> 
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="panel panel-default">
                                                        ...
                                                        <div class="panel-body">
                                                         <div id="diagram-K1" style="width:400px"></div>
                                                     </div>
                                                 </div>
                                                 <!-- END BAR CHART -->
                                             </div>
                                     ...
                                     <div class="tab-pane" id="tab2">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="panel panel-default">
                                                ...
                                                <div class="panel-body">
                                                 <div id="diagram-K4" style="width:400px"></div>
                                             </div>
                                         </div>
                                         <!-- END BAR CHART -->
                                     </div>
                             ...
                             <div class="tab-pane" id="tab3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="panel panel-default">
                                        ...
                                        <div class="panel-body">
                                         <div id="diagram-deteksiResti" style="width:400px"></div>
                                     </div>
                                 </div>
                                 <!-- END BAR CHART -->
                             </div>
                     ...
                     <div class="tab-pane" id="tab4">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <div class="btn-group pull-left">
                                            <button class="btn btn-info" data-toggle="dropdown"><i class="glyphicon glyphicon-time"></i>Tahun <?php echo $tahun; ?></button>
                                            <ul class="dropdown-menu">
                                                <li><a href="<?php echo base_url()."C_Bidan/lihatPemetaan/".$this->session->userdata('desa')."/2015"?>"> 2015</a></li>
                                                <li><a href="<?php echo base_url()."C_Bidan/lihatPemetaan/".$this->session->userdata('desa')."/2016"?>"> 2016</a></li>
                                                <li><a href="<?php echo base_url()."C_Bidan/lihatPemetaan/".$this->session->userdata('desa')."/2017"?>"> 2017</a></li>
                                            </ul>
                                        </div>       
                                        <div class="pull-left" style="padding-left:20px;">
                                            <a href="<?php echo base_url()."C_Bidan/perbaruiPemetaan/".$desa."/".$tahun?>"><button class="btn btn-warning"><i class="fa fa-refresh"></i>Perbarui Data</button></a>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                 <div id="diagram-restiKom" style="width:400px"></div>
                             </div>
                         </div>
                         <!-- END BAR CHART -->
                     </div>
             ...
             <div class="tab-pane" id="tab5">
                ...
                <div class="col-md-6">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                         <div id="diagram-komKeb" style="width:400px"></div>
                     </div>
                 </div>
                 <!-- END BAR CHART -->
             </div>
     ...
     <div class="tab-pane" id="tab6">
        ...
        <div class="col-md-6">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                 <div id="diagram-persalinanNakes" style="width:400px"></div>
             </div>
         </div>
         <!-- END BAR CHART -->
     </div>
...
<div class="tab-pane" id="tab7">
    ...
    <div class="col-md-6">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
             <div id="diagram-persalinanFaskes" style="width:400px"></div>
         </div>
     </div>
     <!-- END BAR CHART -->
 </div>
...
<div class="tab-pane" id="tab8">
    ...
    <div class="col-md-6">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
             <div id="diagram-pelayananNifas" style="width:400px"></div>
         </div>
     </div>
     <!-- END BAR CHART -->
 </div>
                ...
                <div class="tab-pane active" id="tab9">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                             <div id="diagram-KN1" style="width:400px"></div>
                         </div>
                     </div>
                     <!-- END BAR CHART -->
                 </div>
         ...
         <div class="tab-pane" id="tab10">
            ...
            <div class="col-md-6">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                     <div id="diagram-KNlengkap" style="width:400px"></div>
                 </div>
             </div>
             <!-- END BAR CHART -->
         </div>
...
<div class="col-md-6">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div id="diagram-neonatalKomplikasi" style="width:400px"></div>
        </div>
    </div>
    <!-- END BAR CHART -->
</div>
...
<div class="tab-pane" id="tab12">
    ...
    <div class="col-md-6">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div id="diagram-bayiParipurna" style="width:400px"></div>
            </div>
        </div>
        <!-- END BAR CHART -->
    </div>
            ...
            <div class="panel-body tab-content">
                ...
                <div class="col-md-6">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                         <div id="diagram-balitaParipurna" style="width:400px"></div>
                     </div>
                 </div>
                 <!-- END BAR CHART -->
             </div>
     ...
     <div class="tab-pane" id="tab14">
        ...
        <div class="col-md-6">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                 <div id="diagram-aprasParipurna" style="width:400px"></div>
             </div>
         </div>
         <!-- END BAR CHART -->
     </div>
...
<div class="tab-pane" id="tab15">
    ...
    <div class="col-md-6">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div id="diagram-balitaSakit" style="width:400px"></div>
            </div>
        </div>
        <!-- END BAR CHART -->
    </div>
...
<!-- END TEMPLATE -->
<!-- END SCRIPTS -->                 
<?php include("assets/diagramPemetaanDesa.php") ;?>
