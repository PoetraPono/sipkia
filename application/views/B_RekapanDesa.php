    ...
    <div class="page-container">
      ...
      <div class="page-content">
        ...
        <div class="page-title">                    
            <h2><span class="fa fa-arrow-circle-o-left"></span>&nbsp Rekapan PWS-KIA Desa <?php echo ucfirst($desa); ?> Tahun <?php echo $tahun; ?></h2>
        </div>
        <!-- END PAGE TITLE --> 
                ...
                <div class="col-md-12">
                    <div class="panel panel-default tabs">
                        ...
                        <div class="panel-body tab-content">
                            <div class="tab-pane active" id="tabIbu">
                                    ...
                                    <div class="panel-heading">
                                        <div class="btn-group pull-left">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a href="<?php echo base_url()."C_Bidan/lihatRekapan/".$desa."/2014"?>"> 2014</a></li>
                                                <li><a href="<?php echo base_url()."C_Bidan/lihatRekapan/".$desa."/2015"?>"> 2015</a></li>
                                                <li><a href="<?php echo base_url()."C_Bidan/lihatRekapan/".$desa."/2016"?>"> 2016</a></li>
                                                <li><a href="<?php echo base_url()."C_Bidan/lihatRekapan/".$desa."/2017"?>"> 2017</a></li>
                                            </ul>
                                        </div>
                                        <div class="pull-left" style="padding-left:20px;">
                                            <a href="<?php echo base_url()."C_Bidan/perbaruiRekapan/".$desa."/".$tahun?>"><button class="btn btn-warning"><i class="fa fa-refresh"></i>Perbarui Data</button></a>
                                        </div>  
                                            ...
                                            <tbody>
                                                <?php foreach ($data as $row): ?>
                                                    <tr style="font-size:10pt;">
                                                        <tr style="font-size:10pt;">
                                                            <th><?php echo ucfirst($row->bulan); ?></th>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <div class="btn-group pull-left">
                                            <button class="btn btn-info" data-toggle="dropdown"><i class="glyphicon glyphicon-time"></i>Tahun <?php echo $tahun; ?></button>
                                            <ul class="dropdown-menu">
                                                <li><a href="<?php echo base_url()."C_Bidan/lihatRekapan/".$this->session->userdata('desa')."/2015"?>"> 2015</a></li>
                                                <li><a href="<?php echo base_url()."C_Bidan/lihatRekapan/".$this->session->userdata('desa')."/2016"?>"> 2016</a></li>
                                                <li><a href="<?php echo base_url()."C_Bidan/lihatRekapan/".$this->session->userdata('desa')."/2017"?>"> 2017</a></li>
                                            </ul>
                                        </div>
                                ...
                                <div class="pull-right">
                                    <?php foreach ($sasaran as $row): ?>
                                        <strong>Keterangan : Sasaran Bumil = <?php echo $row->sasaranBumil;?>, Sasaran Bumil Risti = <?php echo $row->sasaranBumilRisti;?>, Sasaran Bulin = <?php echo $row->sasaranBulin.".";?></strong>
                                    <?php endforeach ?>
                                </div>       
                            </div>
                            ...
                            <div class="pull-right">
                                <?php foreach ($sasaran as $row): ?>
                                    <strong>Keterangan : Sasaran Bayi = <?php echo $row->sasaranBayi;?>, Sasaran Neo Risti = <?php echo $row->sasaranNeoRisti.".";?></strong>
                                <?php endforeach ?>
                            </div>  
                        </div>
                        <div class="tab-pane" id="tabAnak">
                            ...
                            <div class="pull-right">
                                <?php foreach ($sasaran as $row): ?>
                                    <strong>Keterangan : Sasaran Balita = <?php echo $row->sasaranBalita;?>, Sasaran Apras = <?php echo $row->sasaranApras.".";?></strong>
                                <?php endforeach ?>
                            </div>
                        </div>                        
                    </div>
